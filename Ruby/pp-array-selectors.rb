...
new_array = array.select { |num| num < 20 }
p new_array
...
new_array = array.select { |str| str[0] == "w" }
p new_array
...
new_array = array.select { |hash| hash[:price] > 5 }
p new_array
...
new_array = array.select { |str| str.length < 4 }
p new_array
...
array = [{ name: "chair", price: 100 }, { name: "pencil", price: 1 }, { name: "book", price: 4 }]
new_array = array.select { |hash| hash[:name].length < 6 }
p new_array
...
new_array = array.select { |str| str[0] != "b" }
p new_array
...
array = [{ name: "chair", price: 100 }, { name: "pencil", price: 1 }, { name: "book", price: 4 }]
new_array = array.select { |hash| hash[:price] < 10 }
p new_array
